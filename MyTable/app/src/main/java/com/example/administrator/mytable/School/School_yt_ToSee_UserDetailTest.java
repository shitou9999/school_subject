 ...
 * 头像上传测试
 */
public class School_yt_ToSee_UserDetailTest extends AppCompatActivity implements View.OnClickListener{
...
//                Intent intent=new Intent(School_yt_ToSee_UserDetailTest.this,School_yt_SetDetail.class);
//                Bundle bundle=new Bundle();
//                bundle.putParcelable("data",roundHead);
        ...
        switch(requestCode){
            ...
            case RESULT_PHOTO:
                ...
                if (extras != null) {
                   ...
                   // MyApplication.setBitmap(roundHead);
